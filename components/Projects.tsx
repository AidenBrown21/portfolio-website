        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              ...
              className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl hover:border-orange-500/50 transition-all duration-300 cursor-pointer"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 bg-white/10 border border-gray-700 text-gray-300 rounded-full text-xs font-medium"
                    >
                      {tech}
                    </span>
                  ))}
